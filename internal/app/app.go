...
func (a *Application) RegisterRoutes() {
	...
	printHandler := print_handler.NewPrintHandler(testPrintDir, agentHandler, a.repositories.PartnerProfileRepository, a.repositories.PrintJobRepository, a.repositories.JobCostRepository, a.repositories.AccountRepository, a.redisClient, a.services.CostCalculator, wsHub)
