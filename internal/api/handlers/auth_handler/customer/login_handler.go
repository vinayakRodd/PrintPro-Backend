...
// LoginHandler handles customer login with email and password
...
// HandleLogin handles customer login with email and password
...
func (h *LoginHandler) HandleLogin(w http.ResponseWriter, r *http.Request) {
	...
	if accountRecord.UserType != account.UserTypeCustomer {
		log.Printf("ERROR: Attempted customer login with non-customer account")
	...
	log.Printf("SUCCESS: Customer authenticated successfully")
