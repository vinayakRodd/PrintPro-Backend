...
class PrintAgentGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Cloud Print Agent - Epson L3210")
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                if self.print_job(res.content, color, num_copies, start_page, end_page, page_filter_type, 
                                 individual_color_pages, skip_pages, back_to_back):
    ...
    def print_job(self, pdf_data, color, num_copies=1, start_page=None, end_page=None, 
                  page_filter_type="all", individual_color_pages=None, skip_pages=None, back_to_back=False):
        try:
